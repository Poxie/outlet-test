export default function InstagramIcon({ className, size }: {
    ...
    return(
        <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 28 28" fill="none">
            <path d="M20.5 1H7.5C3.91015 1 1 3.91015 1 7.5V20.5C1 24.0898 3.91015 27 7.5 27H20.5C24.0898 27 27 24.0898 27 20.5V7.5C27 3.91015 24.0898 1 20.5 1Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <path d="M21.15 6.84985H21.1625" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}